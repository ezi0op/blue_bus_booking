...
public class DynamicPricingServiceImpl implements DynamicPricingService {
	...
	public BigDecimal calculateDynamicPrice(Trip trip) {
		log.info("calculateDynamicPrice called for trip: {}", trip != null ? trip.getId() : "null");
		try {
			...
			log.error("Error in calculateDynamicPrice for trip: {}", trip != null ? trip.getId() : "null", e);
			throw e;
		}
	}
	...
	public void applyDynamicPricingToAllActiveTrips() {
		log.info("applyDynamicPricingToAllActiveTrips called");
		try {
			...
			log.error("Error in applyDynamicPricingToAllActiveTrips", e);
			throw e;
		}
	}
