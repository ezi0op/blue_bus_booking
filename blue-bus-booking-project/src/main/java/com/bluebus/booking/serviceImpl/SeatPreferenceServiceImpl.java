...
public class SeatPreferenceServiceImpl implements SeatPreferenceService {
	...
	public SeatPreferenceDTO getPreference(Long userId) {
		log.info("getPreference called with userId: {}", userId);
		try {
			...
			log.error("Error in getPreference with userId: {}", userId, e);
			throw e;
		}
	}
	...
	public void updatePreferenceFromBooking(Long userId, Long bookId) {
		log.info("updatePreferenceFromBooking called with userId: {}, bookId: {}", userId, bookId);
		try {
			...
			log.error("Error in updatePreferenceFromBooking with userId: {}, bookId: {}", userId, bookId, e);
			throw e;
		}
	}
	...
	public void syncAllPastBookings(Long userId) {
		log.info("syncAllPastBookings called with userId: {}", userId);
		try {
			...
			log.error("Error in syncAllPastBookings with userId: {}", userId, e);
			throw e;
		}
	}
